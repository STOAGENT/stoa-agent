...
Invoked by ``stoa kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the STOA Agent board.
...
def _profile_author() -> str:
    """Mirror of ``stoa_cli.kanban._profile_author``."""
    return (
