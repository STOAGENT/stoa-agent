...
TIPS = [
    ...
    "Hermes loads project context from .stoa.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    'hermes chat --ignore-user-config skips ~/.stoa/config.yaml — reproducible bug reports and CI runs.',
