...
def get_container_exec_info() -> Optional[dict]:
    ...
    stoa_bin = info.get("stoa_bin", "/data/current-package/bin/hermes")
...
DEFAULT_CONFIG = {
    ...
    "updates": {
        # Run a full ``hermes backup``-style zip of STOA_HOME before every
        # ``hermes update``.  Backups land in ``<STOA_HOME>/backups/`` and
