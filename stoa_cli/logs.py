...
def tail_log(
    ...
    *,
    ...
    if follow:
        print(f"--- {display_stoa_home()}/logs/{filename}{filter_desc} (Ctrl+C to stop) ---")
    else:
...
def list_logs() -> None:
    ...
    if not log_dir.exists():
        print(f"No logs directory at {display_stoa_home()}/logs/")
        return

    print(f"Log files in {display_stoa_home()}/logs/:\n")
    found = False
