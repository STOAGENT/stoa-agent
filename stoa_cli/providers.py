"""
Single source of truth for provider identity in STOA Agent.
...
STOA_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "qwen-oauth": HermesOverlay(
        ...
        base_url_env_var="STOA_QWEN_BASE_URL",
    ),
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    overlay = STOA_OVERLAYS.get(canonical)
...
def determine_api_mode(provider: str, base_url: str = "") -> str:
    ...
    # Direct provider checks for providers not in STOA_OVERLAYS
    if provider == "bedrock":
