"""
Skills configuration for STOA Agent.
`stoa skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.stoa/config.yaml under:
...
from stoa_cli.config import cfg_get, load_config, save_config
from stoa_cli.colors import Colors, color
from stoa_cli.platforms import PLATFORMS as _PLATFORMS
