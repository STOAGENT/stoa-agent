...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://stoax.xyz/docs/user-guide/messaging/slack/")
    print()
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://stoax.xyz/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://stoax.xyz/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
    print_info("   Open config in your editor:  stoa config edit")
    print_info("   Open config in your editor:  stoa config edit")
