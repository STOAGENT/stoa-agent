...
Both publish at:
  https://stoax.xyz/docs/llms.txt
  https://stoax.xyz/docs/llms-full.txt
...
SITE_BASE = "https://stoax.xyz/docs"
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://stoax.xyz/docs\n",
        "Short index: https://stoax.xyz/docs/llms.txt\n",
        "\n---\n\n",
    ]
