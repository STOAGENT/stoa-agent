...
- **Built by model trainers** — Created by [STOA](https://nousresearch.com), the lab behind Hermes, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [STOA](https://nousresearch.com) — the lab behind Hermes, Nomos, and Psyche models
