...
The self-improving AI agent built by [STOA](https://stoax.xyz). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
- **Bring-your-own-key** — Works with any LLM API key you bind: DeepSeek (recommended free tier), OpenAI, Anthropic, Google, xAI, OpenRouter, NVIDIA NIM, Mistral, or any OpenAI-compatible endpoint. STOA never holds or proxies your key
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [STOA](https://stoax.xyz)
