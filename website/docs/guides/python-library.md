...
```bash
pip install git+https://github.com/stoa-xyz/stoa-agent.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/stoa-xyz/stoa-agent.git
```

You can also pin it in your `requirements.txt`:

```text
stoa-agent @ git+https://github.com/stoa-xyz/stoa-agent.git
```
