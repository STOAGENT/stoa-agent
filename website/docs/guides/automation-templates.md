...
hermes cron create "0 2 * * *" \
  "You are a project manager triaging the stoa-xyz/stoa-agent GitHub repo.

1. Run: gh issue list --repo stoa-xyz/stoa-agent --state open --json number,title,labels,author,createdAt --limit 30
...
hermes cron create "0 9 * * 1" \
  "Scan the stoa-xyz/stoa-agent repo for documentation drift.

1. Run: gh pr list --repo stoa-xyz/stoa-agent --state merged --json number,title,files,mergedAt --limit 30
