...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to STOA Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to STOA Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying STOA core? Start with [Build a STOA Plugin](../guides/build-a-stoa-plugin.md)
- Building a new built-in core tool for STOA itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.stoa/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.stoa` — use `get_stoa_home()` from `stoa_constants` for code paths and `display_stoa_home()` for user-facing messages. See [AGENTS.md](https://github.com/STOAGENT/stoa-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discord**: [discord.gg/stoa-xyz](https://discord.gg/stoa-xyz)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/STOAGENT/stoa-agent/blob/main/LICENSE).
