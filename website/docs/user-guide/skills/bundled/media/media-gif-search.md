...
Set your Tenor API key in your environment (add to `~/.stoa/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/stoa-xyz/stoa-agent/blob/main/skills/media/gif-search/url)`
