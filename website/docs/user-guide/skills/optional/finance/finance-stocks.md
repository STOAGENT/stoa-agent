...
| | |
|---|---|
| Source | Optional — install with `stoa skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), STOA Agent |
| License | MIT |
...
```
SCRIPT=~/.stoa/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.stoa/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
