...
| | |
|---|---|
| Source | Optional — install with `stoa skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"STOA","productType":"Apparel","tags":["test"]}}'
```
