...
4. Name the token (e.g., "STOA Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.stoa/.env`:
...
```bash
CANVAS="python $STOA_HOME/skills/productivity/canvas/scripts/canvas_api.py"
