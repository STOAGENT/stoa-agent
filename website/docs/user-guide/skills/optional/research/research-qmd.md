...
| | |
|---|---|
| Source | Optional — install with `stoa skills install official/research/qmd` |
...
STOA Agent via the native MCP client. This is the preferred
...
Then configure STOA Agent to connect via HTTP:
