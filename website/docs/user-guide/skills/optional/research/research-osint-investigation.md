...
| | |
|---|---|
| Source | Optional — install with `stoa skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | STOA Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $STOA_OSINT_CACHE/icij/ (default: ~/.cache/stoa-osint/icij/).
...
# Set STOA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
