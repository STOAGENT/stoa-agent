...
| | |
|---|---|
| Source | Optional — install with `stoa skills install official/health/neuroskill-bci` |
...
Connect STOA to a running [NeuroSkill](https://neuroskill.com/) instance to read
