...
| | |
|---|---|
| Source | Optional — install with `stoa skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), STOA Agent |
| License | MIT |
...
The script reads `~/.stoa/.env` for two optional defaults:
...
Helper script: `~/.stoa/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.stoa/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.stoa/.env`.
...
```bash
python3 ~/.stoa/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.stoa/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
