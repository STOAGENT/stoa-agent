...
| | |
|---|---|
| Source | Optional — install with `stoa skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), STOA Agent |
| License | MIT |
...
Helper script path: `~/.stoa/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.stoa/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.stoa/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.stoa/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
