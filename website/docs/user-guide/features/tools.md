...
See [Toolsets Reference](/docs/reference/toolsets-reference) for the full set, including platform presets such as `stoa-cli`, `hermes-telegram`, and dynamic MCP toolsets like `mcp-<server>`.
