...
| Google Gemini (OAuth) | `google-gemini-cli` | `hermes model` (Google OAuth; optional: `STOA_GEMINI_PROJECT_ID`) |
...
| Qwen Portal (OAuth) | `qwen-oauth` | `hermes model` (Qwen Portal OAuth; optional: `STOA_QWEN_BASE_URL`) |
