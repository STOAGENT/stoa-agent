...
const config: Config = {
  ...
  themeConfig: {
    image: 'img/stoa-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://stoa-agent.nousresearch.com',
          label: 'Home',
          position: 'right',
        },
        {
        ...
        {
          href: 'https://discord.gg/stoa-xyz',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Built by <a href="https://nousresearch.com">STOA</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
