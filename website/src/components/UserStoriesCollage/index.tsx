  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the STOA Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use STOA &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with STOA?{' '}
        <a
          href="https://github.com/STOAGENT/stoa-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/stoa-xyz" target="_blank" rel="noopener noreferrer">
          STOA Discord
        </a>{' '}
