# Streaming LLM Response Support for STOA Agent
...
```
STOA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("STOA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `stoa_cli/config.py` | 1 | +streaming config defaults |
