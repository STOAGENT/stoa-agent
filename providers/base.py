...
def _profile_user_agent() -> str:
    """Return a ``stoa-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from stoa_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"stoa-cli/{_ver}"
    except Exception:
        return "stoa-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # stoa-cli UA so the catalog endpoint is reachable.
