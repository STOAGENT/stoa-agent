#!/usr/bin/env python3
"""
SWE Runner with STOA Trajectory Format

A runner that uses Stoa-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Stoa-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Stoa-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in STOA format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Stoa-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Stoa-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with STOA Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Stoa-Agent's built-in execution environments
    and outputs trajectories in Stoa-Agent format.
    """
    ...
    def _convert_to_stoa_format(
        ...
        """
        Convert internal message format to STOA trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to STOA trajectory format
        trajectory = self._convert_to_stoa_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with STOA trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with STOA Trajectory Format")
    print("=" * 60)
