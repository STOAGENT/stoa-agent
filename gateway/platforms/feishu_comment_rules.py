...
Config: ~/.stoa/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.stoa/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_stoa_home()`` helper (STOA_HOME-aware and
...
RULES_FILE = get_stoa_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_stoa_home() / "feishu_comment_pairing.json"
