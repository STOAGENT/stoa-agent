...
Trust levels:
  - builtin:   Ships with STOA. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.stoa/\.env|\~/\.stoa/\.env',
     "stoa_env_access", "critical", "exfiltration",
     "directly references STOA secrets file"),
    ...
    (r'\.stoa/config\.yaml|\.stoa/SOUL\.md',
     "stoa_config_mod", "critical", "persistence",
     "references STOA configuration files directly"),
