...
the get_anchored_view / get_messages_around primitives in stoa_state.
...
# Third-party integrations tag their sessions with STOA_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from stoa_state import DEFAULT_DB_PATH
