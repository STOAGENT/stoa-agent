...
``_check_spotify_available()`` — when the user has not run ``stoa auth
spotify``, the tools remain registered (so they appear in ``stoa
...
The Spotify auth flow (``stoa auth spotify``), CLI plumbing, and docs
