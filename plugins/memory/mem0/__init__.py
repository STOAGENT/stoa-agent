...
Config via environment variables:
  ...
  MEM0_USER_ID       — User identifier (default: stoa-user)
  MEM0_AGENT_ID      — Agent identifier (default: stoa)

Or via $STOA_HOME/mem0.json.
"""
...
def _load_config() -> dict:
    """Load config from env vars, with $STOA_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "user_id": os.environ.get("MEM0_USER_ID", "stoa-user"),
        "agent_id": os.environ.get("MEM0_AGENT_ID", "stoa"),
        "rerank": True,
        "keyword_search": False,
    }

    config_path = get_stoa_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, stoa_home):
        """Write config to $STOA_HOME/mem0.json."""
        import json
        from pathlib import Path
        config_path = Path(stoa_home) / "mem0.json"
        existing = {}
        if config_path.exists():
            try:
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "user_id", "description": "User identifier", "default": "stoa-user"},
            {"key": "agent_id", "description": "Agent identifier", "default": "stoa"},
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._user_id = kwargs.get("user_id") or self._config.get("user_id", "stoa-user")
        self._agent_id = self._config.get("agent_id", "stoa")
