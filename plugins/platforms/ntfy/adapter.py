"""ntfy platform adapter (STOA plugin).
...
``plugins/platforms/ntfy/``. The STOA plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "stoa-in"              # subscribe topic (incoming)
          publish_topic: "stoa-out"     # optional — defaults to topic
...
async def _standalone_send(
    ...
    *,
    ...
    ``stoa cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a STOA dependency",
