# STOA Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.stoa/plugins/stoa-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.stoa/plugins/stoa-achievements/scan_checkpoint.json`.
