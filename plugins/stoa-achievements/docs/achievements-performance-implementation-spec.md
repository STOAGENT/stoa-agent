# STOA Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.stoa/plugins/stoa-achievements/state.json` (existing unlock state)
  - `~/.stoa/plugins/stoa-achievements/scan_snapshot.json` (new)
  - `~/.stoa/plugins/stoa-achievements/scan_checkpoint.json` (new)
