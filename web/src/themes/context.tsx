...
const STORAGE_KEY = "stoa-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `stoa_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "stoa-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-stoa-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-stoa-theme-font", "true");
