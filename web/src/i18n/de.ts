...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateSTOA: "STOA aktualisieren",
    updatingSTOA: "STOA wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "STOA-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `stoa plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.stoa/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.stoa/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.stoa/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare STOA-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "STOA-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze STOA mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald STOA ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "STOA scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
