...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateSTOA: "Mettre à jour STOA",
    updatingSTOA: "Mise à jour de STOA…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins STOA (parité avec `stoa plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.stoa/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.stoa/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.stoa/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "STOA Achievements",
      subtitle:
        "Badges STOA à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions STOA en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez STOA davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'STOA détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "STOA analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in STOA Agent ☤",
    },
  },
  kanban: {
