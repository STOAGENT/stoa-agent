 ...
 * `window.__STOA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the STOA brand in the top bar
 ...
 *  `window.__STOA_PLUGINS__.registerSlot(...)`.
 *
