...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/STOAGENT/stoa-agent/v0.14.8/scripts/install.sh | bash
#
# Or with options:
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/STOAGENT/stoa-agent/v0.14.8/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
