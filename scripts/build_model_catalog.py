#!/usr/bin/env python3
"""Build the STOA Model Catalog — a centralized JSON manifest of curated models.
...
STOA CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a STOA release.
...
# Ensure STOA_HOME is set for imports that touch it at module level.
os.environ.setdefault("STOA_HOME", os.path.join(os.path.expanduser("~"), ".stoa"))

from stoa_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "stoa-agent repo",
            "docs": "https://stoa-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
