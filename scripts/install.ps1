...
#
# Usage:
#   iex (irm https://raw.githubusercontent.com/STOAGENT/stoa-agent/v0.14.10/scripts/install.ps1)
#
...
#     1. Invoke-WebRequest `
#          https://raw.githubusercontent.com/STOAGENT/stoa-agent/v0.14.10/scripts/install.ps1 `
#          -OutFile install.ps1
