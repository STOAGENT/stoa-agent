...
REM   curl -fsSL https://raw.githubusercontent.com/STOAGENT/stoa-agent/v0.14.9/scripts/install.cmd -o install.cmd
REM   install.cmd
REM
REM Or use the PowerShell-native bootstrap if you're already in PS:
REM   $env:STOA_INSTALL_SHA256 = '<sha>'
REM   Invoke-WebRequest -Uri https://raw.githubusercontent.com/STOAGENT/stoa-agent/v0.14.9/scripts/install.ps1 -OutFile $env:TEMP\stoa-install.ps1
...
powershell -ExecutionPolicy ByPass -NoProfile -Command ^
    "$ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/STOAGENT/stoa-agent/v0.14.9/scripts/install.ps1' -OutFile '%STOA_INSTALL_TMP%' -UseBasicParsing"

if not exist "%STOA_INSTALL_TMP%" (
    echo.
    echo  Download failed. Check your internet connection or download manually:
    echo    https://github.com/STOAGENT/stoa-agent/blob/v0.14.9/scripts/install.ps1
    echo.
    pause
    exit /b 1
)
