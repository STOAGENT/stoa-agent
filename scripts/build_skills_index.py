#!/usr/bin/env python3
"""Build the STOA Skills Index — a centralized JSON catalog of all skills.
...
`stoa skills search/install` can use it without hitting the GitHub API.
...
# Ensure STOA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building STOA Skills Index...", flush=True)
