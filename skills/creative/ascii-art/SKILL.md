...
```bash
python3 -m pyfiglet "STOA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=STOA&font=Slant" | boxes -d stone
```
