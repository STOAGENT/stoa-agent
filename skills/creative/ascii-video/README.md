...
Built for [STOA Agent](https://github.com/STOAGENT/stoa-agent). Usable in any coding agent. Canonical source lives here; synced to [`STOAGENT/stoa-agent/skills/creative/ascii-video`](https://github.com/STOAGENT/stoa-agent/tree/main/skills/creative/ascii-video) via PR.
