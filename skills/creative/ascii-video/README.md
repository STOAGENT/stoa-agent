...
Built for [STOA Agent](https://github.com/stoa-xyz/stoa-agent). Usable in any coding agent. Canonical source lives here; synced to [`stoa-xyz/stoa-agent/skills/creative/ascii-video`](https://github.com/stoa-xyz/stoa-agent/tree/main/skills/creative/ascii-video) via PR.
