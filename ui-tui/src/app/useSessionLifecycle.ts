...
import type { ScrollBoxHandle } from '@stoa/ink'
import { evictInkCaches } from '@stoa/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.STOA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
