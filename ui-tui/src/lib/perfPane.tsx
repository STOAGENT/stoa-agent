...
//
// Both gate on STOA_DEV_PERF=1 and dump JSON-lines (default ~/.stoa/perf.log,
// override STOA_DEV_PERF_LOG). Tagged { src: 'react' | 'frame' } for jq.
// STOA_DEV_PERF_MS (default 2) skips sub-ms idle frames; set 0 to capture all.
//
