...
def store(tmp_path, monkeypatch):
    ...
    ~/.stoa/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at stoa_state import time, before pytest's STOA_HOME monkeypatch
    fires — the autouse fixture's STOA_HOME override doesn't help here.)
    """
    import stoa_state
