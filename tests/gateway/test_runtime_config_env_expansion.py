...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("STOA_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("STOA_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    monkeypatch.delenv("STOA_GATEWAY_BUSY_INPUT_MODE", raising=False)
    monkeypatch.delenv("STOA_RESTART_DRAIN_TIMEOUT", raising=False)
    monkeypatch.delenv("STOA_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
