"""Tests for the secret-source tracking in ``stoa_cli.env_loader``.

These cover the small public surface that lets `stoa model` / `stoa setup`
...
from stoa_cli import env_loader  # noqa: E402
