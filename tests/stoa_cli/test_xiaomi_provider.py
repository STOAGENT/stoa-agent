...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from stoa_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in STOA_OVERLAYS
        overlay = STOA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify stoa doctor recognizes Xiaomi env vars."""
