...
The main() function in stoa_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `stoa -c model`
...
def _build_parser():
    """Build a minimal replica of the stoa top-level parser."""
