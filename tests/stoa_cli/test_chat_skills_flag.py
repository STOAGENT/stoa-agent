...
def test_top_level_skills_flag_defaults_to_chat(monkeypatch):
    ...
    assert captured == {
        "skills": ["stoa-agent-dev,github-auth"],
        "command": None,
    }
...
def test_chat_subcommand_accepts_skills_flag(monkeypatch):
    ...
    monkeypatch.setattr(
        sys,
        "argv",
        ["stoa", "chat", "-s", "github-auth", "-q", "hello"],
    )
...
def test_chat_subcommand_accepts_image_flag(monkeypatch):
    ...
    monkeypatch.setattr(
        sys,
        "argv",
        ["stoa", "chat", "-q", "hello", "--image", "~/storage/shared/Pictures/cat.png"],
    )
