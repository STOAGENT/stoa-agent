"""Tests for the interactive session browser (`stoa sessions browse`).
...
from stoa_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """stoa sessions browse should be parseable."""
        from stoa_cli.main import main as _main_entry
