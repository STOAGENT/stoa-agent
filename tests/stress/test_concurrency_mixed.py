...
def worker_loop(worker_id: int, stoa_home: str, result_file: str) -> None:
...
def reclaimer_loop(stoa_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="stoa_mixed_stress_")
    print(f"STOA_HOME = {home}")
