...
def _enable_managed_nous_tools(monkeypatch):
    ...
    stoa_cli.auth and stoa_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("stoa_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("stoa_cli.models.check_nous_free_tier", lambda: False)
