...
projection into STOA' display, approval bridging, transcript projection into
...
"codex_app_server"`. STOA' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("STOA_KANBAN_TASK"):
            kanban_db = spawn_env.get("STOA_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "STOA_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("STOA_HOME", os.path.expanduser("~/.stoa")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "stoa",
        client_title: str = "STOA Agent",
